...
HD_PWD='F:/MSI-Work/myip/MJ_inputclk_DS_GBUF/MJ_inputclk_DS_GBUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MJ_inputclk_ds_gbuf.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MJ_inputclk_ds_gbuf.tcl
