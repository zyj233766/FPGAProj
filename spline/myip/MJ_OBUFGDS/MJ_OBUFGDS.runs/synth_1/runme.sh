...
HD_PWD='F:/MSI-Work/myip/MJ_OBUFGDS/MJ_OBUFGDS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MJ_OBUFGDS.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MJ_OBUFGDS.tcl
