...
HD_PWD='F:/MSI-Work/myip/Decode_ADS4249/Decode_ADS4249.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADS4249_Decode.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ADS4249_Decode.tcl
