...
HD_PWD='F:/MSI-Work/myip/MJ_IBUFG_DS/MJ_IBUFG_DS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MJ_IBUFG_DS.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MJ_IBUFG_DS.tcl
