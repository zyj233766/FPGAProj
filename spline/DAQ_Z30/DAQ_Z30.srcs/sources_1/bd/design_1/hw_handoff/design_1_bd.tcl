...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Data_FIFO_Rst_1 [get_bd_ports Data_FIFO_Rst] [get_bd_pins clk_wiz_2/reset] [get_bd_pins fifo_generator_0/srst] [get_bd_pins fifo_generator_1/srst] [get_bd_pins fifo_generator_2/srst] [get_bd_pins fifo_generator_3/srst] [get_bd_pins ila_0/probe6]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_ports MainFIFO_WR_CLK] [get_bd_pins ADS4249_Decode_0/clkinp] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins count_ip_0/s0_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net fifo_generator_0_prog_full [get_bd_ports DataA_FIFO_ProgFull] [get_bd_pins fifo_generator_0/prog_full]
  connect_bd_net -net fifo_generator_1_dout [get_bd_ports DataB_FIFO_RDdata] [get_bd_pins fifo_generator_1/dout]
  connect_bd_net -net fifo_generator_1_prog_full [get_bd_ports DataB_FIFO_ProgFull] [get_bd_pins fifo_generator_1/prog_full]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn1 [get_bd_ports peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins count_ip_0/s0_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
